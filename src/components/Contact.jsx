const socialLinks = [
  ...
  {
    href: "https://x.com/sithum_buddhika",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path
...
const Contact = () => {
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:gap-12">
        <div className="mb-12 lg:mb-0 reveal-up">
          <h2 className="headline-2 mb-6">Let's Collaborate</h2>
          <p className="text-zinc-400 mb-8 max-w-[40ch]">
            Have an idea? Reach out, and let's create something extraordinary
            together.
          </p>
          <div className="flex items-center gap-3">
            {socialLinks.map(({ href, icon, alt }, key) => (
              <a
                ...
                className="w-12 h-12 grid place-items-center rounded-full bg-zinc-800/50 hover:bg-sky-400 hover:text-zinc-950 transition-all duration-300 border border-zinc-50/10"
                aria-label={alt}
              >
                {icon}
              </a>
        ...
        <form
          action="https://getform.io/f/awnnvgqb"
          method="POST"
          className="bg-zinc-800/30 p-8 rounded-3xl backdrop-blur-md border border-zinc-50/10 reveal-up"
        >
          ...
          <div className="mb-4">
            ...
            <textarea
              name="message"
              id="message"
              className="text-field min-h-[150px] resize-y"
              required
